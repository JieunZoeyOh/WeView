...
#board_table th:nth-child(2), td:nth-child(2) {
	text-align: left;
	padding-left: 30px;
	width: 40%
}
...
<body>
	...
	<section class="blog-details-hero set-bg"
		data-setbg="img/blog/details/mypage.jpg"
		style="width: 665px; margin: 0 auto"></section>
								...
								<tbody>
									...
									<c:forEach var="b" items="${boardlist}">
										<tr>
											...
											<!-- 가장 많은 득표를 얻은 제품 -->
											<th>
												<a href="WeviewDetail.com?no=${b.no}" class="bttn bttn-primary bttn-circle bttn-sm" data-toggle="tooltip" data-placement="top" title="글 보러 가기">
													<i style="color: white" class="fa fa-search-plus" aria-hidden="true"></i>
												</a> &nbsp; 
												<a href="WeviewWrittenDelete.com?no=${b.no}" class="bttn bttn-danger bttn-circle bttn-sm deletebttn" data-toggle="tooltip" data-placement="top" title="글 삭제 하기">
