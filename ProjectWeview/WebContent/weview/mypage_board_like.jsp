...
<head>
<meta charset="UTF-8">
<style>#p_active{background: #269ded; border-color: #269ded; color: #ffffff;}</style>
</head>
<body>
    <jsp:include page="header.jsp"></jsp:include>
    <!-- Blog Details Hero Begin -->
    <section class="blog-details-hero set-bg" data-setbg="img/mypage.jpg" style="width:1024px; margin:0 auto">
    </section>
                    ...
                    <div class="blog__sidebar" style="padding-top:0px">                   
                        <div class="blog__sidebar__item">
                        	<div style="border-bottom:3px solid #269DED; width:184px; margin-bottom:20px;">
                        		<h4 style="margin-bottom:15px;">My Page</h4></div>
                            <ul class="hangel">
				...
				<div class="col-lg-8 col-md-8 order-md-1 order-1">
	                ...
	                <table id="board_table" class="table" width="100%" cellspacing="0">
	                  ...
	                  <c:forEach var="b" items="${lovelist}">
	                    <tr>
	                      <td><c:out value="${no}"/>
	                      <c:set var="no" value="${no-1}"/></td>
	                      <td style="text-align:left; width:50%;"><a href="#">${b.title}</a></td>
	                      <td>${b.best}</td>
	                      <th>
	                      <a href="WeviewDetail.com?no=${b.board_no}" class="bttn bttn-primary bttn-circle bttn-sm" data-toggle="tooltip" data-placement="top" title="글 보러 가기">
	                      <i style="color:white" class="fa fa-search-plus" aria-hidden="true"></i></a>
	                      &nbsp;
	                      <a href="WeviewMypageLoveDelete.com?no=${b.no}" class="bttn bttn-heart bttn-circle bttn-sm deletebttn" data-toggle="tooltip" data-placement="top" title="좋아요 취소">
	                      <i style="color:white" class="fa fa-heart" aria-hidden="true"></i></a>
	                      </th>	
	                    </tr>
	                    </c:forEach>
	                  </tbody>
